...
pub(crate) fn get_buy_info(
    ...
    let trade_fee = (U256::from(input_value) * U256::from(fee_multiplier)) / WAD;
    input_value += trade_fee;
...
pub(crate) fn get_sell_info(
    ...
    let trade_fee = output_value * U256::from(fee_multiplier) / WAD;
    output_value -= trade_fee;
